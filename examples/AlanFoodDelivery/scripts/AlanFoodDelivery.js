...
const COMPOUND_ITEM_DELIVERY_INTENT = [
    ...
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME) $(LOC) $(DATE)`,
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME) $(DATE) $(LOC)`,
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(DATE) $(LOC) $(TIME)`,
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(DATE) $(TIME) $(LOC)`,
    `$(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME) $(DATE)`,
    `$(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(DATE) $(TIME)`,
    `$(LOC) $(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(DATE)`,
    `$(LOC) $(TIME) $(DATE) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(LOC) $(DATE) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(LOC) $(DATE) $(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(LOC) $(DATE)`,
    `$(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(DATE) $(LOC)`,
    `$(TIME) $(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(DATE)`,
    `$(TIME) $(LOC) $(DATE) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(TIME) $(DATE) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(LOC)`,
    `$(TIME) $(DATE) $(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(DATE) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(LOC) $(TIME)`,
    `$(DATE) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME) $(LOC)`,
    `$(DATE) $(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(DATE) $(LOC) $(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(DATE) $(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(LOC)`,
    `$(DATE) $(TIME) $(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(ITEM ${ITEMS_INTENT}) $(LOC) $(TIME) $(DATE)`,
    `$(ITEM ${ITEMS_INTENT}) $(LOC) $(DATE) $(TIME)`,
    `$(ITEM ${ITEMS_INTENT}) $(TIME) $(LOC) $(DATE)`,
    `$(ITEM ${ITEMS_INTENT}) $(TIME) $(DATE) $(LOC)`,
    `$(ITEM ${ITEMS_INTENT}) $(DATE) $(LOC) $(TIME)`,
    `$(ITEM ${ITEMS_INTENT}) $(DATE) $(TIME) $(LOC)`,
    `$(LOC) $(ITEM ${ITEMS_INTENT}) $(TIME) $(DATE)`,
    `$(LOC) $(ITEM ${ITEMS_INTENT}) $(DATE) $(TIME)`,
    `$(LOC) $(TIME) $(ITEM ${ITEMS_INTENT}) $(DATE)`,
    `$(LOC) $(TIME) $(DATE) $(ITEM ${ITEMS_INTENT})`,
    `$(LOC) $(DATE) $(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(LOC) $(DATE) $(TIME) $(ITEM ${ITEMS_INTENT})`,
    `$(TIME) $(ITEM ${ITEMS_INTENT}) $(LOC) $(DATE)`,
    `$(TIME) $(ITEM ${ITEMS_INTENT}) $(DATE) $(LOC)`,
    `$(TIME) $(LOC) $(ITEM ${ITEMS_INTENT}) $(DATE)`,
    `$(TIME) $(LOC) $(DATE) $(ITEM ${ITEMS_INTENT})`,
    `$(TIME) $(DATE) $(ITEM ${ITEMS_INTENT}) $(LOC)`,
    `$(TIME) $(DATE) $(LOC) $(ITEM ${ITEMS_INTENT})`,
    `$(DATE) $(ITEM ${ITEMS_INTENT}) $(LOC) $(TIME)`,
    `$(DATE) $(ITEM ${ITEMS_INTENT}) $(TIME) $(LOC)`,
    `$(DATE) $(LOC) $(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(DATE) $(LOC) $(TIME) $(ITEM ${ITEMS_INTENT})`,
    `$(DATE) $(TIME) $(ITEM ${ITEMS_INTENT}) $(LOC)`,
    ...
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME) $(LOC)`,
    `$(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(LOC) $(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT}) $(LOC)`,
    `$(TIME) $(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(LOC) $(TIME) $(DATE)`,
    `$(LOC) $(DATE) $(TIME)`,
    `$(TIME) $(LOC) $(DATE)`,
    `$(TIME) $(DATE) $(LOC)`,
    ...
    `$(ITEM ${ITEMS_INTENT}) $(TIME) $(LOC)`,
    `$(LOC) $(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(LOC) $(TIME) $(ITEM ${ITEMS_INTENT})`,
    `$(TIME) $(ITEM ${ITEMS_INTENT}) $(LOC)`,
    `$(TIME) $(LOC) $(ITEM ${ITEMS_INTENT})`,
    `$(LOC) $(DATE)`,
    `$(DATE) $(LOC)`,
    `$(LOC) $(TIME)`,
    `$(TIME) $(LOC)`,
    `$(TIME) $(DATE)`,
    `$(DATE) $(TIME)`,
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(DATE)`,
    `$(DATE) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(TIME) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(NUMBER) $(ITEM ${ITEMS_INTENT}) $(LOC)`,
    `$(LOC) $(NUMBER) $(ITEM ${ITEMS_INTENT})`,
    `$(ITEM ${ITEMS_INTENT}) $(DATE)`,
    `$(DATE) $(ITEM ${ITEMS_INTENT})`,
    `$(ITEM ${ITEMS_INTENT}) $(TIME)`,
    `$(TIME) $(ITEM ${ITEMS_INTENT})`,
    `$(ITEM ${ITEMS_INTENT}) $(LOC)`,
